...
class DefaultController extends AbstractController
{
    ...
    #[Route('/vertical', name: 'vertical')]
    #[Route(path: '/vertical', defaults: [], name: 'vertical')]
    ...
    #[Route(path: '/wizard/{page}', requirements: ['page' => '[1-9]\d*'], defaults: ['page' => 1], name: 'wizard')]
    ...
    #[Route(path: '/vertical-page', name: 'vertical-page')]
    ...
    #[Route(path: '/navbar-overlapping', defaults: [], name: 'navbar-overlapping')]
    ...
    #[Route(path: '/navbar-vertical', defaults: [], name: 'navbar-vertical')]
    public function navbarVertical(): Response
    {
        return $this->render('default/vertical-navbar.html.twig', []);
    }

    #[Route(path: '/right-to-left', defaults: [], name: 'layout-rtl')]
    ...
    #[Route(path: '/security-centered', defaults: [], name: 'security-centered')]
    public function securityCentered(ContextHelper $contextHelper): Response
    {
        return $this->render('login.html.twig', []);
    }

    #[Route(path: '/security-cover', defaults: [], name: 'security-cover')]
